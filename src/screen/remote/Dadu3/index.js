        ...
        <View style={{ flex: 1, backgroundColor: 'black' }}>
            ...
            <View style={{ height: 90, backgroundColor: 'black', marginTop: 15, justifyContent: "center", alignItems: 'center' }}>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={{ borderWidth: 1, borderRadius: 2, marginHorizontal: 3, width: '20%', height: 30, textAlign: "center", color: "white", borderColor: '#e62129', textAlignVertical: 'center' }}>{nilai.nilai3}</Text>
                </View>
